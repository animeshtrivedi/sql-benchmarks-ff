 ...
 */
public class GeneratedIteratorStoreSalesSplit extends org.apache.spark.sql.execution.BufferedRowIterator {
    ...
    private boolean scan_isNull ;
    private int scan_value ;
    private boolean scan_isNull1 ;
    private int scan_value1 ;
    private boolean scan_isNull2 ;
    private int scan_value2 ;
    private boolean scan_isNull3 ;
    private int scan_value3 ;
    private boolean scan_isNull4 ;
    private int scan_value4 ;
    private boolean scan_isNull5 ;
    private int scan_value5 ;
    private boolean scan_isNull6 ;
    private int scan_value6 ;
    private boolean scan_isNull7 ;
    private int scan_value7 ;
    private boolean scan_isNull8 ;
    private int scan_value8 ;
    private boolean scan_isNull9 ;
    private long scan_value9 ;
    private boolean scan_isNull10 ;
    private int scan_value10 ;
    private boolean scan_isNull11 ;
    private Decimal scan_value11 ;
    private boolean scan_isNull12 ;
    private Decimal scan_value12 ;
    private boolean scan_isNull13 ;
    private Decimal scan_value13 ;
    private boolean scan_isNull14 ;
    private Decimal scan_value14 ;
    private boolean scan_isNull15 ;
    private Decimal scan_value15 ;
    private boolean scan_isNull16 ;
    private Decimal scan_value16 ;
    private boolean scan_isNull17 ;
    private Decimal scan_value17 ;
    private boolean scan_isNull18 ;
    private Decimal scan_value18 ;
    private boolean scan_isNull19 ;
    private Decimal scan_value19 ;
    private boolean scan_isNull20 ;
    private Decimal scan_value20 ;
    private boolean scan_isNull21 ;
    private Decimal scan_value21 ;
    private boolean scan_isNull22 ;
    private Decimal scan_value22 ;

    /* 040 */
/* 041 */   public GeneratedIteratorStoreSalesSplit (Object[] references) {
...
/* 115 */   }
    /* 116 */
    private void readData(int scan_rowIdx){
/* 126 */         scan_isNull = scan_colInstance0.isNullAt(scan_rowIdx);
/* 127 */         scan_value = scan_isNull ? -1 : (scan_colInstance0.getInt(scan_rowIdx));
/* 128 */         scan_isNull1 = scan_colInstance1.isNullAt(scan_rowIdx);
/* 129 */         scan_value1 = scan_isNull1 ? -1 : (scan_colInstance1.getInt(scan_rowIdx));
/* 130 */         scan_isNull2 = scan_colInstance2.isNullAt(scan_rowIdx);
/* 131 */         scan_value2 = scan_isNull2 ? -1 : (scan_colInstance2.getInt(scan_rowIdx));
/* 132 */         scan_isNull3 = scan_colInstance3.isNullAt(scan_rowIdx);
/* 133 */         scan_value3 = scan_isNull3 ? -1 : (scan_colInstance3.getInt(scan_rowIdx));
/* 134 */         scan_isNull4 = scan_colInstance4.isNullAt(scan_rowIdx);
/* 135 */         scan_value4 = scan_isNull4 ? -1 : (scan_colInstance4.getInt(scan_rowIdx));
/* 136 */         scan_isNull5 = scan_colInstance5.isNullAt(scan_rowIdx);
/* 137 */         scan_value5 = scan_isNull5 ? -1 : (scan_colInstance5.getInt(scan_rowIdx));
/* 138 */         scan_isNull6 = scan_colInstance6.isNullAt(scan_rowIdx);
/* 139 */         scan_value6 = scan_isNull6 ? -1 : (scan_colInstance6.getInt(scan_rowIdx));
/* 140 */         scan_isNull7 = scan_colInstance7.isNullAt(scan_rowIdx);
/* 141 */         scan_value7 = scan_isNull7 ? -1 : (scan_colInstance7.getInt(scan_rowIdx));
/* 142 */         scan_isNull8 = scan_colInstance8.isNullAt(scan_rowIdx);
/* 143 */         scan_value8 = scan_isNull8 ? -1 : (scan_colInstance8.getInt(scan_rowIdx));
/* 144 */         scan_isNull9 = scan_colInstance9.isNullAt(scan_rowIdx);
/* 145 */         scan_value9 = scan_isNull9 ? -1L : (scan_colInstance9.getLong(scan_rowIdx));
/* 146 */         scan_isNull10 = scan_colInstance10.isNullAt(scan_rowIdx);
/* 147 */         scan_value10 = scan_isNull10 ? -1 : (scan_colInstance10.getInt(scan_rowIdx));
/* 148 */         scan_isNull11 = scan_colInstance11.isNullAt(scan_rowIdx);
/* 149 */         scan_value11 = scan_isNull11 ? null : (scan_colInstance11.getDecimal(scan_rowIdx, 7, 2));
/* 150 */         scan_isNull12 = scan_colInstance12.isNullAt(scan_rowIdx);
/* 151 */         scan_value12 = scan_isNull12 ? null : (scan_colInstance12.getDecimal(scan_rowIdx, 7, 2));
/* 152 */         scan_isNull13 = scan_colInstance13.isNullAt(scan_rowIdx);
/* 153 */         scan_value13 = scan_isNull13 ? null : (scan_colInstance13.getDecimal(scan_rowIdx, 7, 2));
/* 154 */         scan_isNull14 = scan_colInstance14.isNullAt(scan_rowIdx);
/* 155 */         scan_value14 = scan_isNull14 ? null : (scan_colInstance14.getDecimal(scan_rowIdx, 7, 2));
/* 156 */         scan_isNull15 = scan_colInstance15.isNullAt(scan_rowIdx);
/* 157 */         scan_value15 = scan_isNull15 ? null : (scan_colInstance15.getDecimal(scan_rowIdx, 7, 2));
/* 158 */         scan_isNull16 = scan_colInstance16.isNullAt(scan_rowIdx);
/* 159 */         scan_value16 = scan_isNull16 ? null : (scan_colInstance16.getDecimal(scan_rowIdx, 7, 2));
/* 160 */         scan_isNull17 = scan_colInstance17.isNullAt(scan_rowIdx);
/* 161 */         scan_value17 = scan_isNull17 ? null : (scan_colInstance17.getDecimal(scan_rowIdx, 7, 2));
/* 162 */         scan_isNull18 = scan_colInstance18.isNullAt(scan_rowIdx);
/* 163 */         scan_value18 = scan_isNull18 ? null : (scan_colInstance18.getDecimal(scan_rowIdx, 7, 2));
/* 164 */         scan_isNull19 = scan_colInstance19.isNullAt(scan_rowIdx);
/* 165 */         scan_value19 = scan_isNull19 ? null : (scan_colInstance19.getDecimal(scan_rowIdx, 7, 2));
/* 166 */         scan_isNull20 = scan_colInstance20.isNullAt(scan_rowIdx);
/* 167 */         scan_value20 = scan_isNull20 ? null : (scan_colInstance20.getDecimal(scan_rowIdx, 7, 2));
/* 168 */         scan_isNull21 = scan_colInstance21.isNullAt(scan_rowIdx);
/* 169 */         scan_value21 = scan_isNull21 ? null : (scan_colInstance21.getDecimal(scan_rowIdx, 7, 2));
/* 170 */         scan_isNull22 = scan_colInstance22.isNullAt(scan_rowIdx);
/* 171 */         scan_value22 = scan_isNull22 ? null : (scan_colInstance22.getDecimal(scan_rowIdx, 7, 2));
    }
